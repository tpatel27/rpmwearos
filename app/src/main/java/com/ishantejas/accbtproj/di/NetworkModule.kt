package com.ishantejas.accbtproj.di

import android.app.Application
import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.ishantejas.accbtproj.data.local.datastore.PreferenceDataStore
import com.ishantejas.accbtproj.data.remote.api.HazmatApi
import com.ishantejas.accbtproj.data.remote.api.WorkoutApi
import com.ishantejas.accbtproj.data.remote.api.middleware.DefaultInterceptor
...
class NetworkModule {
    val base = "https://7ad4s780sk.execute-api.us-east-1.amazonaws.com/"
    companion object {
